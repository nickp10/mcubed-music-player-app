...
namespace mCubed {
	public partial class mCubedSecondary : Window {
		...
		private static DateTime _releaseDate = new DateTime(2010, 3, 12);
		...
		private static readonly IEnumerable _credits = new[] {
			new { Author = "Nick Paddock", Project = "mCubed Core", Version = "Music Meta-data Manager (Beta 1)", URL = "http://teknickal.blogspot.com/" },
			new { Author = "Nick Paddock", Project = "mCubed UI", Version = "Music Meta-data Manager (Beta 1)", URL = "http://teknickal.blogspot.com/" },
